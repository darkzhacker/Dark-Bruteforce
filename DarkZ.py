...
[---]        """+wi+"""Dark Z"""+gr+"""        [---]
==================================
[---]  """+wi+"""Facebook BruteForcer  """+gr+""" [---]
==================================
[---]         """+yl+"""CONFIG"""+gr+"""         [---]
==================================
[>] Victim id      :> """+wi+target+gr+"""
...
❥▦▦▦▦R▦▦▦▦▦▦▦▦▦▦❥▦❥▦▦▦▦▦▦▦▦▦R▦▦▦❥❥•❥•❥•❥•❥•❥•❥•❥•
❥▦▦▦▦K▦▦▦▦▦▦▦▦▦▦❥▦▦▦▦▦▦▦▦▦▦▦K▦▦❥❥•❥•❥•❥•❥•❥•❥•❥•
     You need a wordlist to hack someone's account

Example: python Dforcer.py -t (victims Numberic id) -w (wordlist path)
""")
